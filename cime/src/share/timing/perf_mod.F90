...
!-----------------------------------------------------------------------
   ...
   integer, parameter :: max_wtnames=40 !ndk
...
!pw   endif
   ...
   wtnames(5) = "CPL:cime_init"  ! cime/src/drivers/mct/main/cime_comp_mod.F90
   ...
   wtnames(14) = "chk_en_gmean"    ! phys_run1 components/cam/src/physics/cam/physpkg.F90
   wtnames(15) = "stepon_run1"
   wtnames(16) = "phys_run1"
   wtnames(17) = "d_p_coupling"
   wtnames(18) = "bc_aerosols"

   wtnames(2) = "CAM_run2"  ! components/cam/src/cpl/atm_comp_mct.F90
   wtnames(20) = "phys_run2"
   wtnames(21) = "stepon_run2"
   wtnames(22) = "p_d_coupling"

   wtnames(3) = "CAM_run3"  ! components/cam/src/cpl/atm_comp_mct.F90
   wtnames(31) = "stepon_run3"
   wtnames(32) = "prim_run_subcycle"
   wtnames(33) = "prim_run_subcycle_finish"
