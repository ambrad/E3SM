...
# define c_real c_float
  ...
  integer, parameter :: r8 = c_real
  integer  :: pcols, pver, pverp, top_lev
  real(r8) :: epsilo, gravit, latice, latvap, tmelt, rair, cpwv, cpliq, rh2o, &
       &      cpair, h2otrip
...
! Copied from cloud_fraction.F90.
!
