...
inline bool is_inside (const siqk::Mesh<siqk::ko::HostSpace>& m,
...
int get_src_cell (const siqk::Mesh<siqk::ko::HostSpace>& m, // Local mesh.
...
std::string to_string (const siqk::Mesh<siqk::ko::HostSpace>& m) {
  std::stringstream ss;
  ss.precision(17);
...
typedef siqk::Mesh<siqk::ko::HostSpace> Mesh;
